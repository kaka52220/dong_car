...
OLED/csrc/%.o: ../OLED/csrc/%.c $(GEN_OPTS) | $(GEN_FILES) $(GEN_MISC_FILES)
	...
	"G:/MSPM0 3507/CCS/ccs/tools/compiler/ti-cgt-armllvm_4.0.4.LTS/bin/tiarmclang.exe" -c @"device.opt"  -march=thumbv6m -mcpu=cortex-m0plus -mfloat-abi=soft -mlittle-endian -mthumb -O2 -I"G:/dong_car_code/dong_car" -I"G:/dong_car_code/dong_car/Debug" -I"G:/MSPM0 3507/CCS/mspm0_sdk_2_10_00_04/source/third_party/CMSIS/Core/Include" -I"G:/MSPM0 3507/CCS/mspm0_sdk_2_10_00_04/source" -gdwarf-3 -Wall -MMD -MP -MF"OLED/csrc/$(basename $(<F)).d_raw" -MT"$(@)"  $(GEN_OPTS__FLAG) -o"$@" "$<"
